...
//
//
//        List<Point> newinitList1 = DataStream.of(initList)
//                .filter( a->a.x>0 && a.y>0)
//                .map( a->new Point(a.x+=+5,a.y));
////        BrokenLine line1 = DataStream.collect(initList, BrokenLine::new, (l, point)->l.points.add(point));
    }

    //6.2.1
    public static <T extends Point> void moveTo(Line<T> line, int a){
